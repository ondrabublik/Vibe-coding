(function (NS) {
  ...
  // Direct copy from finiteVolumeMethod reference.
  ...
  function ausm(L, R, nx, ny, gamma, fOut) {
    ...
    if (unHalf >= 0.0) {
      rhoUp = L.rho; rhouUp = L.rho * L.u; rhovUp = L.rho * L.v; EpUp = L.E + L.p;
    } else {
      rhoUp = R.rho; rhouUp = R.rho * R.u; rhovUp = R.rho * R.v; EpUp = R.E + R.p;
    }
